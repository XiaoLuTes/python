...
#     # 读取用例
#     with open(r"D:\python\2022-12\first/" + yaml_file, mode='r', encoding='utf-8') as b:
#         value = yaml.load(stream=b, Loader=yaml.FullLoader)
#         return value
#
...
#     with open(r"D:\python\2022-12\first/" + yaml_file, mode="w", encoding="utf-8") as f:
#         yaml.dump(old_data, f)
# def clean_yaml_yl(yaml_file):
#     # 清空全局变量
#     with open(r"D:\python\2022-12\first/" + yaml_file, mode='w', encoding="utf-8") as b:
#         b.truncate()
